...
namespace CosmoS3.Helpers
{
    ...
    internal static class RequestValidator
    {
        ...
        internal static RequestMetadata ValidateAndGetMetadata(S3Context ctx, S3Logger logging, string header)
        {
        ...
        internal static void ValidateAuthorization(RequestMetadata md, S3Logger logging, string header)
        {
        ...
        internal static void ValidateBucketExists(RequestMetadata md, S3Logger logging, string header)
        {
            if (md == null) throw new ArgumentNullException(nameof(md));
            if (logging == null) throw new ArgumentNullException(nameof(logging));
        ...
        internal static void ValidateAuthentication(RequestMetadata md, S3Logger logging, string header)
        {
            if (md == null) throw new ArgumentNullException(nameof(md));
            if (logging == null) throw new ArgumentNullException(nameof(logging));
        ...
        internal static void ValidateObjectExists(Obj obj, long versionId, S3Logger logging, string header)
        {
            if (logging == null) throw new ArgumentNullException(nameof(logging));
        ...
        internal static void ValidateUploadId(S3Context ctx, S3Logger logging, string header)
        {
            if (ctx == null) throw new ArgumentNullException(nameof(ctx));
            if (logging == null) throw new ArgumentNullException(nameof(logging));
        ...
        internal static void ValidateUpload(CosmoS3.Classes.Upload upload, string uploadId, S3Logger logging, string header)
        {
            if (logging == null) throw new ArgumentNullException(nameof(logging));
        ...
        internal static void ValidatePartNumber(int partNumber, S3Logger logging, string header)
        {
            if (logging == null) throw new ArgumentNullException(nameof(logging));
