...
#pragma warning disable CS1998 // Async method lacks 'await' operators and will run synchronously
        ...
        internal async Task<ListAllMyBucketsResult> ListBuckets(S3Context ctx)
        {
            ...
            listBucketsResult.Owner = new CosmoS3.S3Objects.Owner();
            ...
            listBucketsResult.Buckets.BucketList = new List<CosmoS3.S3Objects.Bucket>();

            foreach (Classes.Bucket curr in buckets)
            {
                CosmoS3.S3Objects.Bucket b = new CosmoS3.S3Objects.Bucket();
                b.Name = curr.Name;
