...
public class RouteTableTests
{
    ...
    public void Match_StaticPath_ReturnsMatch()
    {
        ...
        table.Add(HttpMethod.GET, "/ping", _ => Task.CompletedTask);
    ...
    {
        var table = new RouteTable();
        table.Add(HttpMethod.GET, "/users/{id}", _ => Task.CompletedTask);
    ...
    {
        var table = new RouteTable();
        table.Add(HttpMethod.GET, "/orders/{orderId}/items/{itemId}", _ => Task.CompletedTask);
    ...
    {
        var table = new RouteTable();
        table.Add(HttpMethod.GET, "/search", _ => Task.CompletedTask);
    ...
    {
        var table = new RouteTable();
        table.Add(HttpMethod.GET, "/Hello", _ => Task.CompletedTask);
