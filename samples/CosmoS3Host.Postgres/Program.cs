...
// CosmoS3 — PostgreSQL backend
// Port: 8102
// DB:   PostgreSQL (Docker: cosmo_postgres, port 5432)
...
var settings = new SettingsBase
{
    ...
    Database = new DatabaseSettings
    {
        ...
        ConnectionString = "Host=127.0.0.1;Port=5432;Database=cosmos3;Username=cosmo;Password=cosmo123;"
    },
...
Console.WriteLine($"CosmoS3 [PostgreSQL] listening on http://localhost:{port}");
